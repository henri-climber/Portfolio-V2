    ...
    <div className="contact-page" id='contact'>
        ...
        <div className="row">
            <div className="contact-text">
                <p>You are looking to hire a highly motivated software developer intern or know a place where I would be a great fit? You have a project in mind or simply want to say hi? Don’t hestitate to contact me, I am looking forward to connecting with you!</p>
